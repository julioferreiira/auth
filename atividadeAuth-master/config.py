...
TOKEN_TTL = int(os.environ.get("TOKEN_TTL", 3600))   # 1 hora

RESET_TTL = int(os.environ.get("RESET_TTL", 900))    # 15 minutos
...
LOGIN_BLOCK_SECONDS = int(os.environ.get("LOGIN_BLOCK_SECONDS", 600))  # 10 min
